                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label class="col-md-4 col-form-label text-md-end">{{ __('Số Điện Thoại') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label class="col-md-4 col-form-label text-md-end">{{ __('Địa Chỉ') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Nhập lại Password') }}</label>
                                <div class="col-md-6">
